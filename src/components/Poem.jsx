...
export default function Poem() {
    ...
    const deleteItem=(e)=>{
      ...
      y=axios({
        method:"GET",
        url:"http://localhost:8080/delete/"+idt,
        headers: {
  ...
  return (
    ...
    <div className="poems" >
      ...
      {poem.map(c1=>(
          ...
          <div className="postlinks"> <button><a href={"http://localhost:3000/getcontent/"+c1.id}>Edit</a></button> <button style={{"color":"white"}} onClick={deleteItem} value={c1.id} >Delete</button></div>
          </div>
      ))}
      </div>
    </div>
